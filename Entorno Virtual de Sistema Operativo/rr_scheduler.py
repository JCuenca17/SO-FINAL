...
def rr_scheduling(procesos, quantum):
    ...
    while cola:
        ...
        print(f"Ejecutando Proceso {proceso.ID} - Tipo: {proceso.tipo_proceso}, Arribo: {proceso.arribo}, Duración: {proceso.duracion}")
    ...
    for ejec in orden_ejecucion:
        print(f"ID: {ejec['ID']}, Tipo: {ejec['Tipo']}, Arribo: {ejec['Arribo']}, Duración: {ejec['Duración']}, Tiempo final: {ejec['Tiempo_final']}")
