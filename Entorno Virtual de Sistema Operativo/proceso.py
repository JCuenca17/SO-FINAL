...
class Proceso:
    ...
    # def asignar_arribo_aleatorio(self, min_arribo=0, max_arribo=20):
    #     """ Asigna un tiempo de arribo aleatorio dentro de un rango definido. """
    #     self.arribo = random.randint(min_arribo, max_arribo)
...
# Asignando un tiempo de arribo aleatorio a cada proceso
# for proceso in procesos:
#     proceso.asignar_arribo_aleatorio()

# Mostrar los procesos con sus tiempos de arribo asignados aleatoriamente
# for proceso in procesos:
#     print(f"Proceso ID: {proceso.ID}, Arribo: {proceso.arribo}")
